...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(puntos)
       tree position: line 86 of file:///C:/Users/AlumnoM_AI/Desktop/torneo-twenty-one/src/main/scala/Main.scala
            tree tpe: <error>
              symbol: value puntos
...
== Source file context for tree position ==
    ...
    83     
    84     println("\nForeach")
    85     puntuacione_CURSOR_s.foreach { puntos => 
    86         println(s"La puntuacion es de $puntos")
    87     }
    88 }
    89 
