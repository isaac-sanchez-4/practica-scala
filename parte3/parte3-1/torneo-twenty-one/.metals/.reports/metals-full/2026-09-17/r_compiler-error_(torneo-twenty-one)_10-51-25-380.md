...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(puntos)
       tree position: line 79 of file:///C:/Users/AlumnoM_AI/Desktop/torneo-twenty-one/src/main/scala/Main.scala
            tree tpe: <error>
              symbol: value puntos
...
== Source file context for tree position ==
    ...
    76     }
    77     println("Foreach")
    78     _CURSOR_punt.Foreach{puntos =>
    79         println(s"La puntuacion es de $puntos")
    80     }
    81 }
    82 
...
object Main extends App {
    ...
    while (j < puntuacionesRonda2.length){
        val jug = jugadores(j)
        val punt = puntuaciones(j)
        val estado = estadoMano(j)
        println(s"$jug -> $punt -> $estado")
    ...
    println("Comparación de las dos rondas")
