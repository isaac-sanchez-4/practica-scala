...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(puntos)
       tree position: line 87 of file:///C:/Users/AlumnoM_AI/Desktop/torneo-twenty-one/src/main/scala/Main.scala
            tree tpe: <error>
              symbol: value puntos
   symbol definition: puntos: <error> (a TermSymbol)
      symbol package: <empty>
       symbol owners: value puntos -> value $anonfun -> value <local Main> -> object Main
           call site: <none> in <none>

== Source file context for tree position ==

    84     println("\nForeach")
    85     // CORREGIDO: Aplicar a la colección entera con minúscula
    86     puntuacione_CURSOR_s.foreach { puntos => 
    87         println(s"La puntuacion es de $puntos")
    88     }
    89 }
    90 
...
object Main extends App {
    ...
    while (j < puntuacionesRonda2.length){
        ...
        if (estado == "VALIDA") manosValidas2 += 1 else manosBust2 += 1 // CORREGIDO: += 1
        
        mejorPuntuacionRonda2 = mejorMano(mejorPuntuacionRonda2, punt) // CORREGIDO: Actualizar ronda 2
        
        j += 1 // CORREGIDO: Avance del bucle
    }
    ...
    println("\nForeach")
    // CORREGIDO: Aplicar a la colección entera con minúscula
    puntuacione@@s.foreach { puntos => 
